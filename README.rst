...
In certain cases it can be useful to filter the tasks generated by
``giit`` from the command-line. This is done using the task_filter argument.
It simply filters out any tasks that doesn't match the given regular expression.
